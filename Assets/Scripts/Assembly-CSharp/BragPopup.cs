...
public class BragPopup : UIScreen
{
	...
	{
		base.Init();
		_bragHandler = UIScreenController.Instance.screenAnchor.GetComponentInChildren(typeof(FriendHandlerBrag)) as FriendHandlerBrag;
	}
